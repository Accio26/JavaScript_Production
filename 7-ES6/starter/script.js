...
// ES5
console.log('This is ' + firstName + ' ' + lastName + '. He was born is ' + yearOfBirth + '. TOday, he is ' + calcAge(yearOfBirth) + ' years old.');
...
new
Person('Mike').myFriends5(friends);
*/
...
for (const cur of boxesArr6) {
  if (cur.className.includes('blue') === 'boxblue') {
    continue;
  }
...
var suml = addFourAges(18, 30, 12, 21);
console.log(suml);
...
Athlete6('John', 1990, 'swimmer', 3, 19);
...
function reportParks(p) {
  ...
  console.log(`${p[i]} has more than 1000 trees.`);
}
